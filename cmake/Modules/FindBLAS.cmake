...
# bit,sequential code, lp64 model), Intel2017_32, Intel2017_64lp,
# Intel2017_64lp_seq, # Intel( older versions of mkl 32
...
if (BLA_VENDOR MATCHES "Intel" OR BLA_VENDOR STREQUAL "All")
 ...
 if (CMAKE_C_COMPILER_LOADED OR CMAKE_CXX_COMPILER_LOADED)
  ...
  if(BLA_F95)
  MESSAGE(STATUS "Looking for Intel MKL BLAS95 libraries.")
    set(BLAS_mkl_SEARCH_SYMBOL SGEMM)
    set(_LIBRARIES BLAS95_LIBRARIES)
    if (WIN32)
      if (BLA_STATIC)
	  MESSAGE(STATUS "Looking for Intel MKL BLAS95 Static libraries on Win32.")
      ...
      if (BLA_VENDOR MATCHES "Intel.+_32$" OR BLA_VENDOR STREQUAL "All")
	  ...
	  MESSAGE(STATUS "Looking for Intel MKL BLAS95 64lp seq libraries on Win32.")
      ...
      foreach (MAIN ${BLAS_SEARCH_LIBS_WIN_MAIN})
        ...
        endforeach()
      endforeach()
	  MESSAGE(STATUS "Looking for ${BLAS_SEARCH_LIBS}")
    else ()
      if (BLA_VENDOR MATCHES "Intel.*_32$" OR BLA_VENDOR STREQUAL "All")
        list(APPEND BLAS_SEARCH_LIBS
      ...
      if (BLA_VENDOR MATCHES "Intel.*_64lp_seq$" OR BLA_VENDOR STREQUAL "All")
        list(APPEND BLAS_SEARCH_LIBS
