  ...
  */
  ...
  for(std::vector<vector<double> >::iterator q=gammaVec.begin();
    ...
    */
    ...
    //double epsilon = 0.0303089898881*sigma*sigma*Y;
    double epsilon = 0.0023;
    double ARtol = 1.5;
    double PotentialSearchRF=1.5;

    //*************** Bending body parameters ***************//
    double Y = 32.99351128*epsilon/(sigma*sigma) ; // Young's modulus
    double nu = 1.0/3.0;
    ...
    */
    ...
    myfile<<Mat.getEpsilon()<<","<<Mat.getSigma()<<","<<Ravg<<","<<Y<<","
