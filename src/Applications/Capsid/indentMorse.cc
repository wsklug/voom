...
//       if( std::string(optarg) == std::string("no") ) 
  ...
  //Calculate average triangle edge length
  ...
  //calculated such as to set the inflection point of Morse potential
  ...
  // Morse Potential input parameters
  double Rshift = EquilateralEdgeLength/1.122462048;
  ...
  // Protein body implemented using Morse body
