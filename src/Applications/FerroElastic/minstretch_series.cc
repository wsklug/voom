...
int main(int argc, char* argv[])
{
  ...
  inp >> modelName >> in_eta >> in_theta >> KC >> KG >> C0 >> mu >> kS >> min >> Ns >> AngleShift >> OutlineName >> NPout >> HexonShift >> WcType >> WcConst0 >> WcConst1 >> WcConst2;
  inp.close();
  ...
  vector<vector<double > > AngleMatrix(27, vector<double > (3, 0.0) );
  AngleMatrix[0 ][0] = 0.0;   AngleMatrix[0 ][1] = 0.0;        AngleMatrix[0 ][2] = 0.0;
  AngleMatrix[1 ][0] = 0.0;   AngleMatrix[1 ][1] = 0.0;        AngleMatrix[1 ][2] = PI/3.0;
  AngleMatrix[2 ][0] = 0.0;   AngleMatrix[2 ][1] = 0.0;        AngleMatrix[2 ][2] = 2.0*PI/3.0;
  AngleMatrix[3 ][0] = 0.0;   AngleMatrix[3 ][1] = PI/3.0;     AngleMatrix[3 ][2] = 0.0;
  AngleMatrix[4 ][0] = 0.0;   AngleMatrix[4 ][1] = PI/3.0;     AngleMatrix[4 ][2] = PI/3.0;
  AngleMatrix[5 ][0] = 0.0;   AngleMatrix[5 ][1] = PI/3.0;     AngleMatrix[5 ][2] = 2.0*PI/3.0;
  AngleMatrix[6 ][0] = 0.0;   AngleMatrix[6 ][1] = 2.0*PI/3.0; AngleMatrix[6 ][2] = 0.0;
  AngleMatrix[7 ][0] = 0.0;   AngleMatrix[7 ][1] = 2.0*PI/3.0; AngleMatrix[7 ][2] = PI/3.0;
  AngleMatrix[8 ][0] = 0.0;   AngleMatrix[8 ][1] = 2.0*PI/3.0; AngleMatrix[8 ][2] = 2.0*PI/3.0;

  AngleMatrix[9 ][0] = PI/3.0;  AngleMatrix[9 ][1] = 0.0;        AngleMatrix[9 ][2] = 0.0;
  AngleMatrix[10][0] = PI/3.0;  AngleMatrix[10][1] = 0.0;        AngleMatrix[10][2] = PI/3.0;
  AngleMatrix[11][0] = PI/3.0;  AngleMatrix[11][1] = 0.0;        AngleMatrix[11][2] = 2.0*PI/3.0;
  AngleMatrix[12][0] = PI/3.0;  AngleMatrix[12][1] = PI/3.0;     AngleMatrix[12][2] = 0.0;
  AngleMatrix[13][0] = PI/3.0;  AngleMatrix[13][1] = PI/3.0;     AngleMatrix[13][2] = PI/3.0;
  AngleMatrix[14][0] = PI/3.0;  AngleMatrix[14][1] = PI/3.0;     AngleMatrix[14][2] = 2.0*PI/3.0;
  AngleMatrix[15][0] = PI/3.0;  AngleMatrix[15][1] = 2.0*PI/3.0; AngleMatrix[15][2] = 0.0;
  AngleMatrix[16][0] = PI/3.0;  AngleMatrix[16][1] = 2.0*PI/3.0; AngleMatrix[16][2] = PI/3.0;
  AngleMatrix[17][0] = PI/3.0;  AngleMatrix[17][1] = 2.0*PI/3.0; AngleMatrix[17][2] = 2.0*PI/3.0;

  AngleMatrix[18][0] = 2.0*PI/3.0; AngleMatrix[18][1] = 0.0;        AngleMatrix[18][2] = 0.0;
  AngleMatrix[19][0] = 2.0*PI/3.0; AngleMatrix[19][1] = 0.0;        AngleMatrix[19][2] = PI/3.0;
  AngleMatrix[20][0] = 2.0*PI/3.0; AngleMatrix[20][1] = 0.0;        AngleMatrix[20][2] = 2.0*PI/3.0;
  AngleMatrix[21][0] = 2.0*PI/3.0; AngleMatrix[21][1] = PI/3.0;     AngleMatrix[21][2] = 0.0;
  AngleMatrix[22][0] = 2.0*PI/3.0; AngleMatrix[22][1] = PI/3.0;     AngleMatrix[22][2] = PI/3.0;
  AngleMatrix[23][0] = 2.0*PI/3.0; AngleMatrix[23][1] = PI/3.0;     AngleMatrix[23][2] = 2.0*PI/3.0;
  AngleMatrix[24][0] = 2.0*PI/3.0; AngleMatrix[24][1] = 2.0*PI/3.0; AngleMatrix[24][2] = 0.0;
  AngleMatrix[25][0] = 2.0*PI/3.0; AngleMatrix[25][1] = 2.0*PI/3.0; AngleMatrix[25][2] = PI/3.0;
  AngleMatrix[26][0] = 2.0*PI/3.0; AngleMatrix[26][1] = 2.0*PI/3.0; AngleMatrix[26][2] = 2.0*PI/3.0;
  ...
  for (ser = 0; ser < AngleMatrix.size() ; ser++)
    {
      ...
      if (min==2)
	{
      ...
      {
	if (exT < 60) {
	  NonUnifShift[exT] = AngleMatrix[ser][0]; 
	}
	else if (exT< 90) {
	  NonUnifShift[exT] = AngleMatrix[ser][1]; 
	}
	else {
	  NonUnifShift[exT] = AngleMatrix[ser][2]; 
	}
      }
	...
	if (eletype[elT] == 61)
	{
	  AngleOffset[elT] = stretch_angle[elT] + AngleMatrix[ser][0];
	}
	else if (eletype[elT] == 62)
	{
	  AngleOffset[elT] = stretch_angle[elT] + AngleMatrix[ser][1];
	}
	else
	{
	  AngleOffset[elT] = stretch_angle[elT] + AngleMatrix[ser][2];
	}
      }
				...
				bool final)
{
  ...
  for(i = 0; i < NumHexon; i++) {
    ...
    if (final) {
      if (directionNodes.size() == 1) {
      	beta = NonUnifShift[i] + directionNodes[0]->point();
      }
      else {
	beta = NonUnifShift[i] + directionNodes[i]->point();
      }
    }
    else {
      beta = NonUnifShift[i];
