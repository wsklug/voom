...
legend('\tau=0 R=172nm','\tau=1.5 N/m R=130nm','\tau=5 N/m R=175nm');
...
legend('zz max \tau=0 R=172nm',  'zz max \tau=1.5 N/m R=130nm', 'zz max \tau=5 N/m R=175nm');
xlabel('Indentation Depth [nm]');
ylabel('Stress [pN/nm]');
