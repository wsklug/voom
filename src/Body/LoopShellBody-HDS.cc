...
//
// $Log$
// Revision 1.3  2005/10/21 01:27:51  klug
// Added and modified a few accessors.  Removed penalty parameter from
// element construction.
//
// Revision 1.2  2005/10/10 00:45:44  klug
// Exchanged local area constraint for global one.
// Added viscous regularization term to energy.
// Added forces to VTK output.
//
// Revision 1.1  2005/05/23 15:33:30  klug
// Half-edge data structure methods moved from LoopShellBody.cc to LoopShellBody-HDS.cc
//

/*! 
  \file LoopShellBodyllBody-HDS.cc
...
namespace voom {
  ...
  void LoopShellBody< Material_t >::_convertConnectivityToPairs
...
//     p.first = v(2); p.second = v(0); ipc.push_back(p);
  ...
  template< class Material_t >
  void LoopShellBody< Material_t >::_reversePairs(IntPairsContainer& ipc)
  {
  ...
  template< class Material_t >
  void LoopShellBody< Material_t >::_initializeMap( MapHalfedge& mh, 
						    MapVertex& mv, 
  ...
  //! creating HDS
  template< class Material_t >
  void LoopShellBody< Material_t >::_createHDS
  ...
  */
  template< class Material_t >
  int LoopShellBody< Material_t >::_newNodalIndex
...
//   } // end _initNodeNeighbors
  ...
  template< class Material_t >
  void LoopShellBody< Material_t >::_createElement
  ( Material_t material, 
