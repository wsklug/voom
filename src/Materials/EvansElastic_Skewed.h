...
/*! 
  \file EvansElastic_Skewed.h

  \brief Material class for modeling conformational change using singgle welled potential but with a skewed minima

*/

#if !defined(__EvansElastic_Skewed_h__)
#define __EvansElastic_Skewed_h__
...
namespace voom
{
  ...
  */
  ...
  class EvansElastic_Skewed : public SCElastic {
  ...
  protected:
    ...
    //! inverse of the deformation gradient of sheared equilibrium state and the deformation gradient w.r.t. to the sheared equilibrium
    Tensor3D _invhatF, _Fskew;

  public:
//need to add shear direction in the argument list
    EvansElastic_Skewed(const double kC, const double kG, const double C0, double mu, 
...
#endif //  !defined(__EvansElastic_Skewed_h__)
