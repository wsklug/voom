...
namespace voom {
  ...
  int BrownianDynamics::run( int nSteps, double dt) {
  ...
  void BrownianDynamics::computeAndAssemble(bool f0, bool f1, bool f2) 
  {
  ...
  bool BrownianDynamics::checkConsistency(bool verbose) {
