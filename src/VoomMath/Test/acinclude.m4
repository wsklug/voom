...
blitz_includes="/usr/local/blitz"
blitz_libraries="/usr/local/blitz/lib/.libs"

AC_ARG_WITH(blitz-root,
    [  --with-blitz-root=DIR       Blitz root directory],
    [
	ac_blitz_includes="$withval"
       	ac_blitz_libraries="$withval"/lib
    ])
...
ac_link='${CXX-g++} -o conftest $CXXFLAGS -I$blitz_includes -L$blitz_libraries conftest.$ac_ext -lblitz 1>&5'
...
ac_link='${CXX-g++} -o conftest $CXXFLAGS -I$tvmet_includes conftest.$ac_ext 1>&5'
